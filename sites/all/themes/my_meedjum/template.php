...
function my_meedjum_preprocess_html(&$vars, $hook) {
...
function my_meedjum_preprocess_block(&$vars, $hook) {
...
function my_meedjum_preprocess_node(&$vars) {
 ...
 */
function my_meedjum_id_safe($string) {
 ...
 *
 */
function my_meedjum_menu_link(array $variables) {
  ...
  $element['#attributes']['class'][] = my_meedjum_id_safe($element['#title']);
